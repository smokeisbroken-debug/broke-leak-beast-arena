...
export const SKILLS: SkillDefinition[] = [
  ...
  {
    id: "scam_buster_slash",
    name: "Scam Buster Slash",
    slot: "skill_1",
    target: "enemy",
    effect: "damage",
    rarity: "epic",
    ...
    uiColor: "#ff9aaa",
    color: 0xff4866,
    description: "Late-game offense skill for punishing scam and rug-pull bosses after windup.",
  },
  {
    id: "receipt_refund",
    name: "Receipt Refund",
    ...
    uiColor: "#4de8ff",
    color: 0x4de8ff,
    description: "Stronger heal for longer campaign runs and lifestyle chapters.",
  },
  {
    id: "spending_freeze",
    ...
    uiColor: "#b6e8ff",
    color: 0xb6e8ff,
    description: "Large defensive push for resetting spacing against aggressive bosses.",
  },
  {
  ...
  },
  {
    ...
    uiColor: "#ffeb72",
    color: 0xffeb72,
    description: "Alternate ultimate prepared for finisher-style victory moments in later patches.",
  },
];
