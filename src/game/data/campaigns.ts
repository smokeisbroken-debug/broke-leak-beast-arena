...
export const CAMPAIGN_CHAPTERS: CampaignChapterDefinition[] = [
  {
    ...
    description: "Start with readable fights and low-pressure leak enemies.",
    unlockLevel: 1,
    bossIds: ["impulse_buy_beast"],
    color: 0x72ff57,
    uiColor: "#72ff57",
  ...
  },
  {
    ...
    subtitle: "Control FOMO, panic, and rug-pull pressure.",
    description: "Faster opponents, stronger warnings, and harder counter windows.",
    unlockLevel: 2,
    requiredChapterId: "daily_leaks",
    requiredClears: 1,
    bossIds: ["emotional_trading_beast", "rug_pull_beast"],
    color: 0xa45cff,
    uiColor: "#d9a7ff",
  ...
  {
    id: "final_wallet_war",
    name: "Chapter 3 — Wallet War",
    subtitle: "Fight the boss that tries to destroy the wallet.",
    description: "Boss pressure, phase changes, and heavier punishment windows.",
    unlockLevel: 4,
  ...
  {
    id: "lifestyle_leaks",
    name: "Chapter 4 — Lifestyle Leaks",
    subtitle: "Future chapter for food, travel, shopping, and status leaks.",
    description: "Content slot prepared for more bosses, maps, and skins.",
    unlockLevel: 5,
    requiredChapterId: "final_wallet_war",
    requiredClears: 1,
    bossIds: [],
    color: 0x4de8ff,
    uiColor: "#4de8ff",
    rewardLabel: "Coming content",
  },
];
