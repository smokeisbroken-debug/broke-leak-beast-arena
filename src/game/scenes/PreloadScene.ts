...
export class PreloadScene extends Phaser.Scene {
  ...
  private loadVisualAssets(): void {
    ...
    this.load.image("combat-hud-panel", "assets/ui/combat-hud-panel.png?v=035");
    this.load.image("combat-joystick-base", "assets/ui/combat-joystick-base.png?v=035");
    this.load.image("combat-button-slash", "assets/ui/combat-button-slash.png?v=035");
    this.load.image("combat-button-dash", "assets/ui/combat-button-dash.png?v=035");
    this.load.image("combat-button-pulse", "assets/ui/combat-button-pulse.png?v=035");
    this.load.image("combat-button-shield", "assets/ui/combat-button-shield.png?v=035");
    this.load.image("combat-button-auto", "assets/ui/combat-button-auto.png?v=035");
    this.load.image("combat-control-strip", "assets/ui/combat-control-strip.png?v=035");
