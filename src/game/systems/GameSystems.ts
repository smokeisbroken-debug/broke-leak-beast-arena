...
export interface GameSystemsRegistrySnapshot {
  ...
  runValidationPayloadSystem: typeof RUN_VALIDATION_PAYLOAD_SYSTEM_DEFINITION;
  runValidationPayloadSummary: ReturnType<typeof getRunValidationPayloadSummary>;
  ...
  authLinkSystem: typeof AUTH_LINK_SYSTEM_DEFINITION;
  authLinkProviders: typeof AUTH_LINK_PROVIDER_DEFINITIONS;
  authLinkSummary: ReturnType<typeof getAuthLinkSummary>;
  authLinkIdentitySnapshotFactory: typeof createAuthLinkIdentitySnapshot;
  authLinkIdentitySnapshotFromProfileFactory: typeof createAuthLinkIdentitySnapshotFromProfile;
  ...
  remoteDuelSubmitSystem: typeof REMOTE_DUEL_SUBMIT_SYSTEM_DEFINITION;
  remoteDuelSubmitSummary: ReturnType<typeof getRemoteDuelSubmitSummary>;
  remoteDuelSubmitReadinessRows: ReturnType<typeof getRemoteDuelSubmitReadinessRows>;
  remoteDuelSubmitReadinessRowFactory: typeof createRemoteDuelSubmitReadinessRow;
  remoteDuelSubmitRouteFactory: typeof getRemoteDuelSubmitRoute;
...
export const GAME_SYSTEMS_REGISTRY: GameSystemsRegistrySnapshot = {
  ...
  runValidationPayloadSystem: RUN_VALIDATION_PAYLOAD_SYSTEM_DEFINITION,
  runValidationPayloadSummary: getRunValidationPayloadSummary(),
  ...
  authLinkSystem: AUTH_LINK_SYSTEM_DEFINITION,
  authLinkProviders: AUTH_LINK_PROVIDER_DEFINITIONS,
  authLinkSummary: getAuthLinkSummary(),
  authLinkIdentitySnapshotFactory: createAuthLinkIdentitySnapshot,
  authLinkIdentitySnapshotFromProfileFactory: createAuthLinkIdentitySnapshotFromProfile,
  ...
  remoteDuelSubmitSystem: REMOTE_DUEL_SUBMIT_SYSTEM_DEFINITION,
  remoteDuelSubmitSummary: getRemoteDuelSubmitSummary(),
  remoteDuelSubmitReadinessRows: getRemoteDuelSubmitReadinessRows(),
  remoteDuelSubmitReadinessRowFactory: createRemoteDuelSubmitReadinessRow,
  remoteDuelSubmitRouteFactory: getRemoteDuelSubmitRoute,
