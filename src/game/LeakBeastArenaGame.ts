...
import { BalanceDebugScene } from "./scenes/BalanceDebugScene";
...
export function createLeakBeastArenaGame(parent: string): Phaser.Game {
  return new Phaser.Game({
    ...
    scene: [BootScene, PreloadScene, MainMenuScene, SkinSelectScene, SkillLoadoutScene, StageSelectScene, CampaignScene, MissionsScene, LeaderboardScene, TournamentScene, DuelScene, DuelResultScene, BalanceDebugScene, ProfileScene, SettingsScene, ArenaScene, ResultScene],
  });
}
